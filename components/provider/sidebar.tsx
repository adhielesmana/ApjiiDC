...
const menuItems = [
  ...
  {
    href: "/provider/generate-referral",
    label: "Generate Agent",
    icon: TicketIcon,
  },
  { href: "/provider/member", label: "Agent Management", icon: UserIcon },
  { href: "/provider/data-center", label: "Data Center", icon: Building },
  { href: "/provider/space", label: "Product", icon: CubeIcon },
  { href: "/provider/orders", label: "Orders", icon: ShoppingCartIcon },

  // { href: "/provider/services", label: "Services", icon: CubeIcon },
  { href: "/provider/setting", label: "Settings", icon: CogIcon },
];
      ...
      >
        ...
        {!isMobile && (
          <button
            ...
            className="absolute right-[-10px] top-[335px] flex items-center justify-center w-5 h-16 bg-cyan-700 text-white rounded-r-lg shadow-xl hover:bg-cyan-800 transition-all z-50 border-2 border-cyan border-l-0"
            ...
            <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-blue-600/30">
              ...
              <div>
                ...
                <p className="text-xs text-white/80">
                  {user?.provider?.name || "Service Provider"}
                </p>
              </div>
            </div>
          </div>
