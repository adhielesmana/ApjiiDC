...
function middleware(request) {
    ...
    const isBecomeProviderRoute = request.nextUrl.pathname === "/customer/become-provider";
    try {
        ...
        if (!token && (isAdminRoute || isProviderRoute || isOrderRoute || isBecomeProviderRoute)) {
        ...
        if (isAdminRoute || isProviderRoute || isOrderRoute || isBecomeProviderRoute) {
