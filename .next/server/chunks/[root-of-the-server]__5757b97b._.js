module.exports = [
"[project]/.next-internal/server/app/api/setting/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/setting/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].get(`${BACKEND_URL}/catalogue/settings`, {});
        // Ensure PPN is properly included in the response
        if (response.data.status === "ok" && response.data.data) {
            // If PPN isn't set in the response but should be, set a default
            if (response.data.data.ppn === undefined || response.data.data.ppn === null) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5757b97b._.js.map